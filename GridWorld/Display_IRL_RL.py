...
def difference_Expert_Inverse(env,seed=None):
    # 用来比较
    print("Reinforcement Learning")
    validate_learnedQ(env, 'ExpertQ_'+str(seed))
    print("Inverse Reinfocement Learning")
    validate_learnedQ(env, 'learnedQ_'+str(seed))

if __name__ == '__main__':
    seed = 5
    env = RandomGridWorld(seed)

    difference_Expert_Inverse(env,seed)